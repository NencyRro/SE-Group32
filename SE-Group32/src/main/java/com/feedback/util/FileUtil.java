...
public class FileUtil {
    ...
    public static String readFromFile(String fileName) {
        ...
        try (InputStream is = FileUtil.class.getClassLoader().getResourceAsStream(fileName)) {
            ...
            System.err.println("Error reading resource file from classpath: " + e.getMessage());
            // Fallback to file system read if resource loading fails
        }
        ...
        try {
            ...
            return "Error reading file from file system: " + e.getMessage();
        }
    }
}