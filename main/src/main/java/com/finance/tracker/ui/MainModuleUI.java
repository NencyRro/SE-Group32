...
public class MainModuleUI extends JFrame {
    ...
    private Object transactionPanel;
    ...
    private JPanel createTitleBar() {
        ...
        infoButton.addActionListener(e -> {
            // 显示反馈页面
            new com.feedback.ui.MainFrame().setVisible(true);
        });
    ...
    private void updateLanguage() {
        ...
        if (transactionPanel != null) {
            if (transactionPanel instanceof TransactionPanel) {
                ((TransactionPanel) transactionPanel).updateLanguage();
            } else if (transactionPanel instanceof TransactionDashboardPanel) {
                ((TransactionDashboardPanel) transactionPanel).updateLanguage();
            }
        }
    ...
    private JButton createMenuButton(String key, String text, Icon icon) {
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                // 如果是transaction按钮，则显示交易面板而不是直接打开交易表单窗口
                if (key.equals("transaction")) {
                    // 如果transactionPanel为null，则创建一个新的TransactionDashboardPanel
                    if (transactionPanel == null) {
                        transactionPanel = new TransactionDashboardPanel(MainModuleUI.this);
                    }
    ...
    private void initFunctionalPanels() {
        try {
            ...
            transactionPanel = new TransactionDashboardPanel(this);
            ...
            mainContentPanel.add((Component)transactionPanel, TRANSACTION_PANEL);
    ...
    public void showPanel(String key) {
        // 如果找到了cardLayout和mainContentPanel，则切换到指定面板
        if (cardLayout != null && mainContentPanel != null) {
            cardLayout.show(mainContentPanel, key);
            
            // 如果是推荐面板，还需要刷新推荐
            if (key.equals("recommendation") && recommendationPanel != null) {
                recommendationPanel.onPanelShown();
            }
        }
    }
