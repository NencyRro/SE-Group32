...
public class ReportAndNotificationUI extends JFrame {
    ...
    private JPanel createReportPanel() {
        ...
        csvExportBtn.addActionListener(e -> exportCSVReport());

        JButton pdfExportBtn = new JButton("Export PDF Report");
        pdfExportBtn.addActionListener(e -> exportPDFReport());
    ...
    private JPanel createBudgetAlertPanel() {
        ...
        checkBudgetBtn.addActionListener(e -> {
            try {
    ...
    private void exportPDFReport() {
        try {
            ...
            service.exportPDFReport(transactions, filename);
            JOptionPane.showMessageDialog(this, "PDF Report Exported: " + filename, "Export Successful", JOptionPane.INFORMATION_MESSAGE);
        } catch (Exception e) {
